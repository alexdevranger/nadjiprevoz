...
//   // Pozovi izračunavanje rute kada se promene koordinate
//   useEffect(() => {
//     // Funkcija za izračunavanje rute
...
//         alert("Greška pri izračunavanju rute. Proverite adrese.");
//       } finally {
//         setUpdating(false);
//       }
//     };
...
//     } catch (err) {
//       console.error(err);
//       alert("Greška pri izmeni zahteva.");
//     }
//   };
...
//       <h1 className="text-2xl font-bold mb-4">Izmena zahteva</h1>
...
//           }}
//         />
//         <label className="ml-[2px] mb-[-5px] text-[14px]">
//           Izaberite datum
//         </label>
//         <DatePicker
//           selected={form.date}
...
//           required
//         />
//         <label className="ml-[2px] mb-[-5px] text-[14px]">Težina (kg)</label>
//         <input
//           type="number"
//           name="weightKg"
//           value={form.weightKg}
...
//           className="border p-2 rounded"
//         />
//         <label className="ml-[2px] mb-[-5px] text-[14px]">Broj paleta</label>
//         <input
//           type="text"
//           name="pallets"
//           value={form.pallets}
...
//           className="border p-2 rounded"
//         />
//         <label className="ml-[2px] mb-[-5px] text-[14px]">Dužina (cm)</label>
//         <input
//           name="length"
...
//         />
//         <label className="ml-[2px] mb-[-5px] text-[14px]">Širina (cm)</label>
//         <input
//           name="width"
...
//           className="border p-2"
//         />
//         <label className="ml-[2px] mb-[-5px] text-[14px]">Visina (cm)</label>
//         <input
//           name="height"
...
//           className="border p-2"
//         />{" "}
//         <label className="ml-[2px] mb-[-5px] text-[14px]">Vrsta robe</label>
//         <input
//           type="text"
//           name="goodsType"
...
//         <input
//           type="text"
//           value={form.distanceMeters / 1000 || ""}
//           readOnly
//           className="border p-2 w-full bg-gray-100"
//         />
//         <label>Vreme prevoza (minuti)</label>
//         <input
//           type="text"
//           value={Math.round(form.durationSec / 60) || ""}
//           readOnly
//           className="border p-2 w-full bg-gray-100"
//         />
//         {updating && (
//           <div className="text-blue-600 text-sm">Izračunavam novu rutu...</div>
//         )}
//         <label className="ml-[2px] mb-[-5px] text-[14px]">Napomena</label>
//         <textarea
//           name="note"
//           value={form.note}
//           onChange={handleChange}
...
//         >
//           {updating ? "Računam..." : "Sačuvaj izmene"}
//         </button>
//       </form>
//     </div>
//   );
