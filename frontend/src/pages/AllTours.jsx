...
//       const toursArray = res.data.tours || [];

//       const futureTours = toursArray.filter((tour) => {
...
//                       Prethodna
//                     </button>
//                     <span className="px-3 py-1">Strana {page}</span>
//                     <button
...
//                         setPage(1); // reset na prvu stranu
//                       }}
//                       className="border rounded px-2 py-1"
//                     >
//                       <option value={20}>20 po stranici</option>
//                       <option value={40}>40 po stranici</option>
//                       <option value={60}>60 po stranici</option>
//                     </select>
//                   </div>
//                 </div>
//               )}
...
//   const fetchTours = async () => {
//     setLoading(true);
//     let dateStr = filterDate ? format(filterDate, "yyyy-MM-dd") : ""; // Promenjen format datuma
...
//       // Ispravka: res.data je objekat, res.data.tours je array
//       const toursArray = res.data.tours || [];

//       // NE FILTRIRAMO OVDE FUTURE TOURS jer to već radi backend
//       // Samo prikažemo sve ture koje backend vrati
//       setTours(toursArray);
//       setTotal(res.data.total || 0);

//       // Čuvamo sve ture samo kada nema filtera
//       if (
//         !filterDate &&
//         !filterVehicleType &&
//         !filterCapacity &&
...
//     setFilterCapacity("");
//     setFilterStartLocation("");
//     setPage(1); // Resetujemo na prvu stranu
//   };
...
//   // Izračunavanje ukupnog broja strana
...
//         {/* Paginacija - OVO JE SADA ODVOJENO I ISPRAVLJENO */}
