...
//             <h2 className="text-xl font-semibold mb-4">Profilna slika</h2>
...
//                   {user?.name?.charAt(0) || user?.companyName?.charAt(0) || "K"}
//                 </div>
//               )}
...
//                       className="mt-2 bg-red-500 hover:bg-red-600 text-white px-3 py-1 rounded text-sm flex items-center"
//                     >
//                       <FaTimes className="mr-1" /> Obriši profilnu sliku
//                     </button>
//                   )}
//                 </div>
...
//             <div className="mt-8">
//               <h3 className="text-lg font-medium mb-3">Lični podaci</h3>
...
//                 </div>
//                 <div>
//                   <p className="text-sm text-gray-600">Kompanija</p>
//                   <p className="font-medium">
...
//                 </div>
//                 <div>
//                   <p className="text-sm text-gray-600">Uloga</p>
//                   <p className="font-medium">
...
//                 }`}
//               >
//                 <FaSignOutAlt className="inline mr-1" /> Odjavi se
//               </button>
//             </nav>
//           </div>
//         </div>
...
//       //         <FaUser className="mr-2 text-blue-500" /> Profilna slika
//       //       </h2>
...
//       //                 type="button"
//       //                 onClick={handleDeleteProfileImage}
//       //                 className="mt-2 bg-red-500 hover:bg-red-600 text-white px-3 py-1 rounded text-base flex items-center"
//       //               >
//       //                 <FaTimes className="mr-1" /> Obriši profilnu sliku
//       //               </button>
//       //             )}
...
//       //             <FaUser className="mr-2 text-blue-500" /> Lični podaci
//       //           </h3>
//       //           {!editingProfile ? (
//       //             <button
//       //               onClick={() => setEditingProfile(true)}
//       //               className="bg-blue-500 hover:bg-blue-600 text-white px-3 py-1 rounded text-base flex items-center"
//       //             >
...
//       //                 className="bg-green-500 hover:bg-green-600 text-white px-3 py-1 rounded text-base flex items-center"
//       //               >
...
//       //                   setUploadMessage("");
//       //                 }}
//       //                 className="bg-gray-500 hover:bg-gray-600 text-white px-3 py-1 rounded text-base"
//       //               >
//       //                 Odustani
//       //               </button>
//       //             </div>
...
//       //               <FaUserCircle className="mr-1 text-blue-400" /> Ime
//       //             </p>
//       //             {editingProfile ? (
//       //               <input
//       //                 type="text"
...
//       //           <div>
//       //             <p className="text-sm text-gray-600 flex items-center">
//       //               <FaBuilding className="mr-1 text-blue-400" /> Kompanija
//       //             </p>
//       //             {editingProfile ? (
//       //               <div className="flex items-center">
//       //                 <input
...
//       //                     className="ml-2 bg-red-500 hover:bg-red-600 text-white p-2 rounded text-sm flex items-center"
...
//       //           <div>
//       //             <p className="text-sm text-gray-600 flex items-center">
//       //               <FaEnvelope className="mr-1 text-blue-400" /> Email
//       //             </p>
//       //             <p className="font-medium">
//       //               {user?.email || "Nije postavljen"}
//       //             </p>
...
//       //           <div>
//       //             <p className="text-sm text-gray-600 flex items-center">
//       //               <FaUserTag className="mr-1 text-blue-400" /> Uloga
//       //             </p>
//       //             <p className="font-medium">
//       //               {user?.roles?.join(", ") || "Nije postavljena"}
//       //             </p>
...
//                     type="button"
//                     onClick={handleDeleteProfileImage}
//                     className="mt-3 bg-red-500 hover:bg-red-600 text-white px-3 py-1 rounded flex items-center text-sm"
//                   >
//                     <FaTimes className="mr-1" /> Obriši sliku
//                   </button>
//                 )}
