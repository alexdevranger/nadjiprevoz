...
const ShopPage = () => {
  ...
  useEffect(() => {
    if (shop) {
      // U praksi bi ovde bio API poziv
      setJobAds(sampleJobAds);
    }
  }, [shop]);
          ...
          <div className="flex justify-end mb-4">
            <div className="flex items-center gap-2 bg-white rounded-lg shadow-sm px-4 py-2">
              ...
              <select
                ...
                className="border border-gray-300 rounded-lg px-3 py-1 focus:outline-none focus:ring-2 focus:ring-purple-500 text-sm"
              >
                <option value={20}>20</option>
                <option value={40}>40</option>
                <option value={60}>60</option>
            ...
            <div className="bg-white rounded-xl shadow-md p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
                {jobAds.map((job, index) => (
                  <div
                    key={job._id}
                    className="border border-orange-200 rounded-xl p-6 bg-orange-50 hover:shadow-lg transition-all duration-300"
                  >
