...
const ShopPage = () => {
  ...
  // Hardkodovani oglasi za posao - u praksi bi došli iz API-ja
  const sampleJobAds = [
    {
      _id: "1",
      title: "Tražim vozača za međunarodni transport",
      type: "Vozač kamiona",
      location: "Beograd",
      employmentType: "Full-time",
      salary: "1200-1500€",
      description:
        "Tražimo iskusnog vozača za međunarodni transport robe. Potrebna B kategorija sa CE dozvolom, minimum 3 godine iskustva.",
      requirements: [
        "B kategorija sa CE",
        "Min. 3 godine iskustva",
        "Poštovanje rokova",
        "Odgovoran odnos prema vozilu",
      ],
      contactEmail: "posao@transport.com",
    ...
    {
      _id: "2",
      title: "Vozač za gradski transport",
      type: "Vozač dostavnog vozila",
      location: "Novi Sad",
      employmentType: "Part-time",
      salary: "Po satu",
      description:
        "Potreban vozač za dostavu paketa u gradu. Fleksibilno radno vreme, mogućnost dodatnih sati.",
      requirements: [
        "B kategorija",
        "Vozačka iskustvo",
        "Poznavanje grada",
      ...
      contactEmail: "dostava@transport.com",
  ...
  const fetchShipments = async () => {
    ...
    params.append("byUser", shop.userId._id);
  ...
  const handleShopJobs = async (id) => {
    try {
      const res = await axios.get(`/api/jobs/shop/${shop._id}`);
  ...
  // Učitaj oglase za posao kada se shop učita
  useEffect(() => {
    if (shop) {
      handleShopJobs();
    }
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-mainDarkBG ">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                {jobAds.length > 0 && (
                  <div className="absolute -top-2 -right-2 bg-[#adadad] text-white rounded-full w-10 h-10 flex items-center justify-center text-xs font-bold shadow-lg border-2 border-white/20 cursor-help group">
                    <FaUserTie className="text-xs" />
                    <span className="ml-0.5">{jobAds.length}</span>

                    {/* Custom tooltip */}
                    <div className="absolute -top-8 -left-4 bg-gray-800 text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap pointer-events-none">
                      {jobAds.length === 1
                        ? "1 oglas za posao"
                        : `${jobAds.length} oglasa za posao`}
              ...
              {/* Statistika - PROŠIRENA SA TURAMA I ZAHTEVIMA */}
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="bg-white/10 rounded-lg p-3 text-center border border-white/10">
                  ...
                  <div className="text-xs text-gray-300">Aktivne ture</div>
                </div>
                <div className="bg-white/10 rounded-lg p-3 text-center border border-white/10">
                  <div className="text-2xl font-bold text-purple-400">
                    {totalShipmentsCount}
                  </div>
                  <div className="text-xs text-gray-300">Aktivni zahtevi</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-8">
        ...
        {vehicles.length === 0 && (
          <div className="bg-white dark:bg-cardBGText rounded-xl shadow-md p-6 text-center">
            <FaTruck className="text-4xl text-gray-400 dark:text-gray-200 mx-auto mb-4" />
        ...
        <div className="w-full mx-auto pb-8">
          <div className="bg-white dark:bg-cardBGText rounded-xl shadow-md p-6 mb-6 mt-8">
            <h2 className="text-lg font-semibold text-gray-800 dark:text-white mb-4 flex items-center">
              <FaFilter className="text-blue-500 mr-2" />
              Aktivne ture ({totalToursCount})
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div>
                ...
                <DatePicker
                  ...
                  className="dark:bg-cardBGText dark:text-white w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
          ...
          {/* Prikaži po strani za ture */}
          <div className="flex justify-end mb-4">
            <div className="flex items-center gap-2 bg-white dark:bg-cardBGText rounded-lg shadow-sm px-4 py-2">
              <label className="text-sm text-gray-700 dark:text-white whitespace-nowrap">
                Prikaži po strani:
              </label>
              <select
                value={limit}
                ...
                className="dark:bg-cardBGText dark:text-white border border-gray-300 rounded-lg px-3 py-1 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
              >
          ...
          <div className="bg-white dark:bg-cardBGText rounded-xl shadow-md overflow-hidden mb-6">
            ...
            {tours.length === 0 ? (
              ...
              <>
                <div className="p-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {tours.map((tour, index) => {
                    ...
                    return (
                      <div
                        key={tour._id}
                        className={`dark:bg-cardBGText relative rounded-xl shadow-md p-5 flex flex-col justify-between transition-all duration-300 hover:shadow-lg hover:translate-y-[-2px] ${
                          isPremium
                      ...
                      >
                        ...
                        <div className="flex-1 space-y-2 leading-tight text-sm text-gray-700 dark:text-white">
                          ...
                          {/* Napomena */}
                          {tour.note && (
                            <div className="text-gray-600 dark:text-white italic mt-2">
                ...
                {/* Paginacija za ture */}
                {totalPages > 1 && (
                  <div className="bg-white dark:bg-cardBGText rounded-xl shadow-md p-6 mt-6">
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                      <div className="text-sm text-gray-600 dark:text-white">
                        Prikazano {tours.length} od {totalToursCount} tura •
        ...
        <div className="w-full mx-auto pb-8">
          <div className="bg-white dark:bg-cardBGText rounded-xl shadow-md p-6 mb-6 mt-8">
            <h2 className="text-lg font-semibold text-gray-800 dark:text-white mb-4 flex items-center">
              ...
              Aktivni zahtevi za prevoz ({totalShipmentsCount})
            </h2>

            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              {/* Datum zahteva */}
              <div>
                <label className="text-sm font-medium dark:text-white text-gray-700 mb-2 flex items-center">
                ...
                <DatePicker
                  ...
                  isClearable
                  placeholderText="Svi datumi"
                  className="dark:text-white dark:bg-cardBGText w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-purple-500"
                  dateFormat="d. MMMM yyyy"
                  locale="sr-latin"
                  minDate={new Date()}
                />
          ...
          {/* Prikaži po strani za zahteve */}
          <div className="flex justify-end mb-4">
            <div className="flex items-center gap-2 bg-white dark:text-white dark:bg-cardBGText rounded-lg shadow-sm px-4 py-2">
              <label className="text-sm text-gray-700 dark:text-white whitespace-nowrap">
                Prikaži po strani:
              </label>
              <select
                ...
                onChange={(e) => {
                  setShipmentsLimit(Number(e.target.value));
                  setShipmentsPage(1);
                }}
                className="dark:text-white dark:bg-cardBGText border border-gray-300 rounded-lg px-3 py-1 focus:outline-none focus:ring-2 focus:ring-purple-500 text-sm"
              >
                <option value={20}>20</option>
                <option value={40}>40</option>
                <option value={60}>60</option>
          ...
          <div className="bg-white dark:bg-cardBGText rounded-xl shadow-md overflow-hidden mb-6">
            ...
            {shipments.length === 0 ? (
              ...
              <>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex-1 space-y-2 leading-tight text-sm text-gray-700 dark:text-white">
                          ...
                          {/* Napomena */}
                          {shipment.note && (
                            <div className="text-gray-600 dark:text-gray-200 italic text-sm mt-2">
                ...
                {/* Paginacija za zahteve */}
                {Math.ceil(totalShipmentsCount / shipmentsLimit) > 1 && (
                  <div className="bg-white rounded-xl shadow-md p-6 mt-6">
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                      <div className="text-sm text-gray-600">
                        Prikazano {shipments.length} od {totalShipmentsCount}{" "}
                        zahteva • Strana {shipmentsPage} od{" "}
                        {Math.ceil(totalShipmentsCount / shipmentsLimit)}
                      </div>
                            ...
                            {[
                              ...Array(
                                Math.min(
                                  5,
                                  Math.ceil(
                                    totalShipmentsCount / shipmentsLimit
                                  )
                                )
                              ),
                            ].map((_, i) => {
                              ...
                              return (
                                <button
                                  key={pageNumber}
                                  onClick={() => setShipmentsPage(pageNumber)}
                                  className={`w-10 h-10 rounded-lg flex items-center justify-center ${
                                    shipmentsPage === pageNumber
        ...
        {jobAds.length > 0 && (
          <div className="w-full mx-auto pb-8">
            <div className="bg-white dark:bg-cardBGText rounded-xl shadow-md p-6">
              <h2 className="text-xl font-semibold mb-6 flex items-center text-orange-500">
                <FaUserTie className="mr-2" />
                Oglasi za posao ({jobAds.length})
              </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
                {jobAds.map((job, index) => (
                  <div
                    key={job._id}
                    className="border border-orange-200 rounded-xl p-6 bg-orange-50 dark:bg-mainDarkBG hover:shadow-lg transition-all duration-300"
                  >
                      ...
                      <div className="flex flex-col sm:flex-row gap-3">
                        {job.contactPhone && (
                          <a
                            ...
                            className="flex-1 bg-green-500 hover:bg-green-600 text-white py-2 px-4 rounded-lg text-center text-sm font-medium transition-colors flex items-center justify-center"
                          >
                        ...
                        {job.contactEmail && (
                          <a
                            ...
                            className="flex-1 bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded-lg text-center text-sm font-medium transition-colors flex items-center justify-center"
                          >
